    ...
    <Html lang={currentLocale}>
      <Head>
        ...
        {process.env.NODE_ENV === 'development' && (
          <script dangerouslySetInnerHTML={{ __html: 'window.sensorica_theme = "light"; window.sensorica_client_id = "10";window.post_id = "85"; window.chatUniqId = sensorica_client_id+"_"+post_id; window.main_title = "Welcome to Sensorica AI Presale Consultant. Ready to Guide You!";window.sensorica_openaiproxy = "https://refactored-fortnight-w945676vw9h9pqp-3000.app.github.dev/";' }}></script>
        )}
      </Head>
      <body>
        <Main />
